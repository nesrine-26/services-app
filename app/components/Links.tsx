...
const Links = () => {
  ...
  return (
    <section
      id="links"
      className="flex flex-col lg:flex-row w-full min-h-[600px] items-stretch overflow-hidden transition-colors duration-500"
    >
      {/* Right Section: Image Background */}
      <div
        className={`relative w-full lg:w-1/2 min-h-[350px] lg:min-h-full transition-all duration-1000 transform ${mounted ? "translate-x-0 opacity-100" : "translate-x-20 opacity-0"}`}
      >
        <img
