...
export default function About() {
  ...
  return (
    <div
      id="about"
      className="relative justify-center items-center  bg-white dark:bg-slate-950 font-sans selection:bg-cyan-100 dark:selection:bg-indigo-900 min-h-screen flex flex-col md:flex-row overflow-hidden px-4 py-12 md:py-0 gap-8 md:gap-12 transition-colors duration-500"
    >
      ...
      >
        <div
          ...
          style={{
            ...
            WebkitMaskImage: `
              radial-gradient(circle 45px at 35% 25%, black 100%, transparent 100%),
              radial-gradient(circle 45px at 65% 25%, black 100%, transparent 100%),
            ...
            maskImage: `
              ...
              radial-gradient(circle 60px at 20% 50%, black 100%, transparent 100%),
              radial-gradient(circle 60px at 50% 50%, black 100%, transparent 100%),
              radial-gradient(circle 60px at 80% 50%, black 100%, transparent 100%),
              radial-gradient(circle 60px at 35% 75%, black 100%, transparent 100%),
              radial-gradient(circle 60px at 65% 75%, black 100%, transparent 100%)
            `,
